...
if __name__ == "__main__":
    ...
    args = parser.parse_args('--seed 1 --env-id PongNoFrameskip-v0 --eval-steps 10000'.split(' '))
    ...
    for train_step in range(args.train_step):
        if train_step % args.train_frequency == 0:
            ...
            with torch.no_grad():
                ...
                current_value = q_network.network(s_next_obses)
                target_value = target_network.network(s_next_obses)
