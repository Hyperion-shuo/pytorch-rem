...
if __name__ == "__main__":
    ...
    parser.add_argument("--env-id", type=str, default="BreakoutNoFrameskip-v0", help="the id of the environment")
    ...
    # args = parser.parse_args('--seed 1 --env-id PongNoFrameskip-v0 --eval-steps 30000 --buffer-num 1 \
        # --track --wandb-project-name rem_breakout'.split(' '))
