...
if __name__ == "__main__":
    ...
    args = parser.parse_args('--seed 1 --env-id PongNoFrameskip-v0 --track --wandb-project-name wandb_test --exp-name online_dqn_pong'.split(' '))
    if not args.seed:
...
for global_step in range(args.total_timesteps):
    ...
    if global_step > args.learning_start and global_step % args.train_frequency == 0:
        ...
        if global_step % 1000 == 0:
            ...
            writer.add_scalar("losses/average_target_max_values", target_max.mean().item(), global_step)
